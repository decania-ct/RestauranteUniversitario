...
//
//  Created by Felipe Podolan Oliveira on 12/07/17.
...
class QueuesTableViewCell: UITableViewCell {
    ...
    /// The noQueues label when there are no available queues
    @IBOutlet weak var noQueuesLabel: UILabel!
